<?php
//主机地址
defined('DB_URL') or define('DB_URL', '192.168.10.10');

//主机端口,默认mysql为3306
defined('DB_PORT') or define('DB_PORT', '3306');

//连接数据库的用户名
defined('DB_USER') or define('DB_USER', 'saturn001');

//连接数据库的密码，推荐使用随机生成的字符串
defined('DB_PASSWORD') or define('DB_PASSWORD', 'newlife123');

//数据库名
defined('DB_NAME') or define('DB_NAME', 'influxlink');
...
//网站名称
defined('WEBSITE_NAME') or define('WEBSITE_NAME', '轻松速达开放平台');
